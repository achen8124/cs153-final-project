...
# a = "sc"
# b = "shakespeare_clip"
# detect_faces(f"../../shared/frames/{b}1",f"{a}1_output/{a}1_mtcnn_output.txt")

# detect_faces(f"../../shared/frames/{b}2",f"{a}2_output/{a}2_mtcnn_output.txt")

# print(os.getcwd())
# def detect_faces(frames_path, filename, filetype):
# for i in range(1, 1346):
#   detect_face(f"../../shared/frames/no_country_clip2/no_country_clip2_{i:05d}.png")
