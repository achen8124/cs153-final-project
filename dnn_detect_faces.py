...
detect_faces('../../shared/frames/slumdog', 'slumdog_output/slumdog_dnn_output.txt')
detect_faces('../../shared/frames/shakespeare_clip2', 'sc2_output/sc2_dnn_output.txt')
detect_faces('../../shared/frames/unforgiven', 'unforgiven_output/unforgiven_dnn_output.txt')
